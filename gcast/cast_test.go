...
func BenchmarkTrimZeroDecimal(b *testing.B) {
    for i := 0; i < b.N; i++ {
        cast.trimZeroDecimal("")
        cast.trimZeroDecimal("123")
        cast.trimZeroDecimal("120")
        cast.trimZeroDecimal("120.00")
    }
}
...
func TestToTimeWithTimezones(t *testing.T) {
    ...
    for i, format := range cast.timeFormats {
        format := format
        if format.typ == cast.timeFormatTimeOnly {
            continue
        }
...
func TestTrimZeroDecimal(t *testing.T) {
    ...
    c.Assert(cast.trimZeroDecimal("10.0"), qt.Equals, "10")
    c.Assert(cast.trimZeroDecimal("10.00"), qt.Equals, "10")
    c.Assert(cast.trimZeroDecimal("10.010"), qt.Equals, "10.010")
    c.Assert(cast.trimZeroDecimal("0.0000000000"), qt.Equals, "0")
    c.Assert(cast.trimZeroDecimal("0.00000000001"), qt.Equals, "0.00000000001")
