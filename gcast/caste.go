...
func ToInt64E(i interface{}) (int64, error) {
    ...
    case nil:
        return 0, nil
    default:
        if it := reflect.TypeOf(i).Kind(); it >= reflect.Int && it <= reflect.Uint64 {
            v, err := strconv.ParseInt(fmt.Sprintf("%d", reflect.ValueOf(i).Interface()), 0, 64)
            if err != nil {
...
func ToInt32E(i interface{}) (int32, error) {
    ...
    default:
        if it := reflect.TypeOf(i).Kind(); it >= reflect.Int && it <= reflect.Uint64 {
            v, err := strconv.ParseInt(fmt.Sprintf("%d", reflect.ValueOf(i).Interface()), 0, 32)
            if err != nil {
                return 0, fmt.Errorf("unable to cast %#v of type %T to int32", i, i)
            }
            return int32(v), nil
...
func ToInt16E(i interface{}) (int16, error) {
    ...
    default:
        if it := reflect.TypeOf(i).Kind(); it >= reflect.Int && it <= reflect.Uint64 {
            v, err := strconv.ParseInt(fmt.Sprintf("%d", reflect.ValueOf(i).Interface()), 0, 16)
            if err != nil {
                return 0, fmt.Errorf("unable to cast %#v of type %T to int16", i, i)
            }
            return int16(v), nil
...
func ToInt8E(i interface{}) (int8, error) {
    ...
    default:
        if it := reflect.TypeOf(i).Kind(); it >= reflect.Int && it <= reflect.Uint64 {
            v, err := strconv.ParseInt(fmt.Sprintf("%d", reflect.ValueOf(i).Interface()), 0, 8)
            if err != nil {
                return 0, fmt.Errorf("unable to cast %#v of type %T to int8", i, i)
            }
            return int8(v), nil
...
func ToIntE(i interface{}) (int, error) {
    ...
    default:
        if it := reflect.TypeOf(i).Kind(); it >= reflect.Int && it <= reflect.Uint64 {
            v, err := strconv.ParseInt(fmt.Sprintf("%d", reflect.ValueOf(i).Interface()), 0, 0)
            if err != nil {
...
func ToUintE(i interface{}) (uint, error) {
    ...
    default:
        if it := reflect.TypeOf(i).Kind(); it >= reflect.Int && it <= reflect.Uint64 {
            v, err := strconv.ParseUint(fmt.Sprintf("%d", reflect.ValueOf(i).Interface()), 0, 0)
            if err != nil {
                return 0, fmt.Errorf("unable to cast %#v of type %T to uint", i, i)
            }
            return uint(v), nil
...
func ToUint64E(i interface{}) (uint64, error) {
    ...
    default:
        if it := reflect.TypeOf(i).Kind(); it >= reflect.Int && it <= reflect.Uint64 {
            v, err := strconv.ParseUint(fmt.Sprintf("%d", reflect.ValueOf(i).Interface()), 0, 64)
            if err != nil {
                return 0, fmt.Errorf("unable to cast %#v of type %T to uint64", i, i)
            }
            return v, nil
...
func ToUint32E(i interface{}) (uint32, error) {
    ...
    default:
        if it := reflect.TypeOf(i).Kind(); it >= reflect.Int && it <= reflect.Uint64 {
            v, err := strconv.ParseUint(fmt.Sprintf("%d", reflect.ValueOf(i).Interface()), 0, 32)
            if err != nil {
                return 0, fmt.Errorf("unable to cast %#v of type %T to uint32", i, i)
            }
            return uint32(v), nil
...
func ToUint16E(i interface{}) (uint16, error) {
    ...
    default:
        if it := reflect.TypeOf(i).Kind(); it >= reflect.Int && it <= reflect.Uint64 {
            v, err := strconv.ParseUint(fmt.Sprintf("%d", reflect.ValueOf(i).Interface()), 0, 16)
            if err != nil {
                return 0, fmt.Errorf("unable to cast %#v of type %T to uint16", i, i)
            }
            return uint16(v), nil
...
func ToUint8E(i interface{}) (uint8, error) {
    ...
    default:
        if it := reflect.TypeOf(i).Kind(); it >= reflect.Int && it <= reflect.Uint64 {
            v, err := strconv.ParseUint(fmt.Sprintf("%d", reflect.ValueOf(i).Interface()), 0, 8)
            if err != nil {
                return 0, fmt.Errorf("unable to cast %#v of type %T to uint8", i, i)
            }
            return uint8(v), nil
